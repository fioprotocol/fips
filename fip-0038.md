...
|Invalid owner permission|Format of the permission is not valid.|400|"owner" (what field from above? Needs to conform to ABI)|Value sent in, i.e. "123"|"Invalid owner permission format"|
