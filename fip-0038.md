...
```
#### Processing
* Both `owner` and `active` permissions are required
...
|---|---|---|---|---|---|
|Invalid FIO Public Key|Format of FIO Public Key is not valid.|400|"fio_public_key"|Value sent in, i.e. "123"|"Invalid FIO Public Key"|
|Invalid owner permission|Format of the permission is not valid.|400|"owner" (what field from above? Needs to conform to ABI)|Value sent in, i.e. "123"|"Invalid owner permission format"|git pu
|Invalid active permission|Format of the permission is not valid.|400|"active"(what field from above? Needs to conform to ABI)|Value sent in, i.e. "123"|"Invalid active permission format"|
