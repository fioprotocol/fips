...
Transfer FIO Address released in [fio v2.0.0](https://github.com/fioprotocol/fio/releases/tag/v2.0.0), [fio.contracts v2.3.0](https://github.com/fioprotocol/fio.contracts/releases/tag/v2.3.0)

The transfer_fio_address API endpoint will be released in a future FIO chain release.
