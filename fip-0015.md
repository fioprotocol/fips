...
# Specification
The following list has been started by FIO Protocol integrators. If you are integrating the FIO Protocol and want to update this list with new chain/token codes that you will be using with the FIO Protocol, please submit pull request with your updates.
...
|XLM|XLM|{address}?memo={value}|Stellar|148|
|XNS|XNS||Insolar|453|
