...
## Contract address instead of token code
In addition to token codes, FIO Request and FIO Data now allows contract address to be passed in instead of token code. For more information see: [Support for contract address in FIO Request and FIO Data](https://dev.fio.net/changelog/support-for-contract-address-in-fio-request-and-fio-data#/)
